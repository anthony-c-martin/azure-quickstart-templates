...
param artifactsLocation string = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-private-endpoint-sql-from-appservice/'
...
resource privateDnsZoneName_privateDnsZoneName_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2018-09-01' = {
  ...
  name: '${privateDnsZoneName_var}-link'
  location: 'global'
  properties: {
