...
resource vmName_newuserscript 'Microsoft.Compute/virtualMachines/extensions@2015-06-15' = {
  ...
  properties: {
    ...
    settings: {
      fileUris: [
        'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/ethereum-cpp-on-ubuntu/configure-eth-cpp.sh'
      ]
      commandToExecute: 'sh configure-eth-cpp.sh ${adminUsername}'
    }
  }
  dependsOn: [
    vmName_resource
