...
param artifactsLocation string = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-blob-storage-private-endpoint/'
...
var adlsStorageAccountId = adlsStorageAccountName_resource.id
...
var adlsPrivateDnsZoneName_var = 'privatelink${adlsPublicDNSZoneForwarder}'
var blobPrivateDnsZoneName_var = 'privatelink${blobPublicDNSZoneForwarder}'
var adlsPrivateDnsZoneId = adlsPrivateDnsZoneName.id
...
var adlsStorageAccountPrivateEndpointId = adlsStorageAccountPrivateEndpointName_resource.id
...
resource adlsStorageAccountName_resource 'Microsoft.Storage/storageAccounts@2019-06-01' = {
...
resource adlsPrivateDnsZoneName 'Microsoft.Network/privateDnsZones@2018-09-01' = {
...
resource adlsPrivateDnsZoneName_link_to_virtualNetworkName 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2018-09-01' = {
  parent: adlsPrivateDnsZoneName
...
resource adlsStorageAccountPrivateEndpointName_resource 'Microsoft.Network/privateEndpoints@2020-04-01' = {
...
output adlsStorageAccountPrivateEndpoint object = reference(adlsStorageAccountPrivateEndpointName_resource.id, '2020-04-01', 'Full')
...
output adlsStorageAccount object = reference(adlsStorageAccountName_resource.id, '2019-06-01', 'Full')
