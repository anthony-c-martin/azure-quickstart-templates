    ...
    siteConfig: {
      appSettings: [
        ...
        }
        {
          ...
          value: reference(Microsoft_Insights_components_functionAppName.id, '2018-05-01-preview').InstrumentationKey
        }
        {
...
resource Microsoft_Insights_components_functionAppName 'Microsoft.Insights/components@2018-05-01-preview' = {
  name: functionAppName
