...
resource accountName_keyspaceName 'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces@2020-06-01-preview' = {
...
resource accountName_keyspaceName_tableName 'Microsoft.DocumentDb/databaseAccounts/cassandraKeyspaces/tables@2020-06-01-preview' = {
  parent: accountName_keyspaceName
  name: tableName
  properties: {
    resource: {
      id: tableName
