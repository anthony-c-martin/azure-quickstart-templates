...
resource virtual_hub1_cfg_name_ERGW 'Microsoft.Network/expressRouteGateways@2020-05-01' = {
  ...
  dependsOn: [
    virtual_hub1_cfg_name_vnet2_cfg_name_connection
  ]
}
...
resource virtual_hub2_cfg_name_ERGW 'Microsoft.Network/expressRouteGateways@2020-05-01' = {
  ...
  dependsOn: [
    virtual_hub2_cfg_name_vnet4_cfg_name_connection
  ]
}
        ...
        properties: {
          routingConfiguration: {
            associatedRouteTable: {
              id: resourceId('Microsoft.Network/virtualHubs/hubRouteTables', virtual_hub1_cfg.name, 'defaultRouteTable')
            }
    ...
    p2SConnectionConfigurations: [
      {
        ...
        properties: {
          routingConfiguration: {
            associatedRouteTable: {
              id: resourceId('Microsoft.Network/virtualHubs/hubRouteTables', virtual_hub2_cfg.name, 'defaultRouteTable')
            }
            propagatedRouteTables: {
              labels: [
                'default'
