...
param firewallPolicyName string = 'firewallPolicy${uniqueString(resourceGroup().id)}'
...
resource ipgroups_name1_resource 'Microsoft.Network/ipGroups@2019-12-01' = {
  name: ipgroups_name1
  location: location
  properties: {
    ipAddresses: [
...
resource ipgroups_name2_resource 'Microsoft.Network/ipGroups@2019-12-01' = {
  name: ipgroups_name2
  location: location
  properties: {
    ipAddresses: [
...
resource azfwRouteTableName 'Microsoft.Network/routeTables@2019-12-01' = {
...
resource publicIPNamePrefix_1 'Microsoft.Network/publicIPAddresses@2019-12-01' = [for i in range(0, numberOfFirewallPublicIPAddresses): {
...
resource jumpBoxPublicIPAddressName 'Microsoft.Network/publicIPAddresses@2019-12-01' = {
...
resource jumpBoxNsgName 'Microsoft.Network/networkSecurityGroups@2019-12-01' = {
...
resource JumpBoxNicName 'Microsoft.Network/networkInterfaces@2019-12-01' = {
...
resource ServerNicName 'Microsoft.Network/networkInterfaces@2019-12-01' = {
...
resource firewallPolicyName_RuleCollectionGroup1 'Microsoft.Network/firewallPolicies/ruleCollectionGroups@2020-05-01' = {
