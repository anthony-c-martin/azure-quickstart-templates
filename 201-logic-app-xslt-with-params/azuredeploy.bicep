...
param integrationAccountName string = 'IntegrationAccount'

@minLength(1)
@maxLength(80)
@description('Name of the Logic App.')
param logicAppName string = 'XSLTWithParams'
...
resource integrationAccountName_map_with_params 'Microsoft.Logic/integrationAccounts/maps@2016-06-01' = {
  parent: integrationAccountName_resource
  properties: {
    mapType: 'Xslt'
