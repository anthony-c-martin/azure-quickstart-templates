...
param artifactsLocation string = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/sap-3-tier-marketplace-image-md/'
...
var csExtension = {
  Windows: {
    ...
    Version: '1.7'
    script: uri(artifactsLocation, 'diskConfig.ps1${artifactsLocationSasToken}')
  ...
  Linux: {
    ...
    Name: 'CustomScript'
    Version: '2.0'
    script: uri(artifactsLocation, 'diskConfig.sh${artifactsLocationSasToken}')
...
resource nsgName 'Microsoft.Network/networkSecurityGroups@2020-05-01' = if (length(subnetId) == 0) {
...
resource vnetName 'Microsoft.Network/virtualNetworks@2020-05-01' = if (length(subnetId) == 0) {
  name: vnetName_var
  location: location
  properties: {
    addressSpace: {
...
resource vmNameASCS_csExtension_internalOSType_Name 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = [for i in range(0, ascsvmCount): {
...
resource vmNameDB_csExtension_internalOSType_Name 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = [for i in range(0, dbvmCount): {
...
resource vmNameDI_csExtension_internalOSType_Name 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = [for i in range(0, divmCount): {
