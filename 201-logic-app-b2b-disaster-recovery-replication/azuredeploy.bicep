...
param DR_LogicApp_Location string = resourceGroup().location
param Primary_IntegrationAccountResourceGroup string = 'primary-rg'

@description('Integration Account Name')
param Primary_IntegrationAccountName string = 'primary-ia'

@description('Integration Account Name')
param Secondary_IntegrationAccountName string = 'secondary-ia'
