...
resource vaultName_resource 'Microsoft.RecoveryServices/vaults@2020-02-02' = if (isNewVault) {
  name: vaultName
  location: location
  sku: {
    name: 'RS0'
...
resource vaultName_policyName 'Microsoft.RecoveryServices/vaults/backupPolicies@2020-02-02' = if (isNewPolicy) {
...
resource vaultName_backupFabric_storagecontainer_Storage_existingResourceGroupName_existingStorageAccountName 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2020-02-02' = if (registerStorageAccount) {
...
resource vaultName_backupFabric_storagecontainer_Storage_existingResourceGroupName_existingStorageAccountName_AzureFileShare_existingFileShareName 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2020-02-02' = {
  parent: vaultName_backupFabric_storagecontainer_Storage_existingResourceGroupName_existingStorageAccountName
