...
param artifactsLocation string = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/301-storage-spaces-direct-md-zones/'
...
var deployS2DClusterTemplateURL = uri(artifactsLocation, 'nestedtemplates/deploy-s2d-cluster.json${artifactsLocationSasToken}')
