...
param clusterName string = 'sf-${uniqueString(resourceGroup().id)}'
...
param vmImageSku string = '16.04-LTS'
...
param supportLogStorageAccountType string = 'Standard_LRS'
...
param applicationDiagnosticsStorageAccountType string = 'Standard_LRS'
