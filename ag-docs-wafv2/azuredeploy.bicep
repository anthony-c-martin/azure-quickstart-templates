...
resource publicIPAddress 'Microsoft.Network/publicIPAddresses@2020-06-01' = [for i in range(0, 3): {
...
resource virtualMachines_myVM_name_1_IIS 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = [for i in range(0, 2): {
...
resource applicationGateways_myAppGateway_name 'Microsoft.Network/applicationGateways@2020-06-01' = {
...
resource AGWafPol01 'Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies@2020-06-01' = {
  name: AGWafPol01_var
  location: location
  properties: {
    customRules: [
