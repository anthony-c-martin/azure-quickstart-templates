...
resource existingRecoveryServicesVaultName_backupFabric_existingProtectionContainers_existingProtectableItems 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2016-06-01' = [for (item, i) in existingProtectableItems: {
