...
param eventHubsNamespaceName string = 'eventhubs${uniqueString(resourceGroup().id)}'
...
param consumerGroupName string = 'consumergroup${uniqueString(resourceGroup().id)}'

@description('Enabling this property creates a Event Hubs Namespace in regions that support availability zones.')
param eventHubsNamespaceZoneRedundant bool = false
...
param artifactsLocation string = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-eventhubs-private-endpoint/'
...
param scriptFileName string = 'eventhubs_nslookup.sh'
...
param eventHubsNamespacePrivateEndpointName string = 'EventHubsNamespacePrivateEndpoint'
...
var eventHubsNamespaceId = eventHubsNamespaceName_resource.id
var blobStorageAccountId = blobStorageAccountName_resource.id
var eventHubsPublicDNSZoneForwarder = ((toLower(environment().name) == 'azureusgovernment') ? '.servicebus.usgovcloudapi.net' : '.servicebus.windows.net')
var blobPublicDNSZoneForwarder = '.blob.${environment().suffixes.storage}'
var eventHubsNamespacePrivateDnsZoneName_var = 'privatelink${eventHubsPublicDNSZoneForwarder}'
var blobPrivateDnsZoneName_var = 'privatelink${blobPublicDNSZoneForwarder}'
var eventHubsNamespacePrivateDnsZoneId = eventHubsNamespacePrivateDnsZoneName.id
var blobPrivateDnsZoneId = blobPrivateDnsZoneName.id
var eventHubsNamespaceEndpoint = concat(eventHubsNamespaceName, eventHubsPublicDNSZoneForwarder)
var blobServicePrimaryEndpoint = concat(blobStorageAccountName, blobPublicDNSZoneForwarder)
var eventHubsNamespacePrivateEndpointId = eventHubsNamespacePrivateEndpointName_resource.id
var blobStorageAccountPrivateEndpointId = blobStorageAccountPrivateEndpointName_resource.id
var eventHubsNamespacePrivateEndpointGroupName = 'namespace'
var blobStorageAccountPrivateEndpointGroupName = 'blob'
var eventHubsNamespacePrivateDnsZoneGroup_var = '${eventHubsNamespacePrivateEndpointName}/${eventHubsNamespacePrivateEndpointGroupName}PrivateDnsZoneGroup'
...
resource eventHubsNamespaceName_resource 'Microsoft.EventHub/namespaces@2018-01-01-preview' = {
  ...
  properties: {
    zoneRedundant: eventHubsNamespaceZoneRedundant
  }
}

resource eventHubsNamespaceName_eventHubName 'Microsoft.EventHub/namespaces/eventhubs@2017-04-01' = {
  parent: eventHubsNamespaceName_resource
  name: '${eventHubName}'
  properties: {}
  dependsOn: [
...
resource eventHubsNamespaceName_eventHubName_consumerGroupName 'Microsoft.EventHub/namespaces/eventhubs/consumergroups@2017-04-01' = {
  parent: eventHubsNamespaceName_eventHubName
...
resource vmName_resource 'Microsoft.Compute/virtualMachines@2019-12-01' = {
  ...
  dependsOn: [
    eventHubsNamespacePrivateEndpointId
...
resource vmName_customScriptExtensionName 'Microsoft.Compute/virtualMachines/extensions@2019-12-01' = {
  ...
  properties: {
    ...
    protectedSettings: {
      commandToExecute: 'bash ${scriptFileName} ${eventHubsNamespaceEndpoint} ${blobServicePrimaryEndpoint}'
    }
  }
  dependsOn: [
    vmId
...
resource eventHubsNamespacePrivateDnsZoneName 'Microsoft.Network/privateDnsZones@2018-09-01' = {
  name: eventHubsNamespacePrivateDnsZoneName_var
  location: 'global'
  properties: {
...
resource eventHubsNamespacePrivateDnsZoneName_link_to_virtualNetworkName 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2018-09-01' = {
  parent: eventHubsNamespacePrivateDnsZoneName
  ...
  dependsOn: [
    eventHubsNamespacePrivateDnsZoneId
    vnetId
  ]
}
...
resource eventHubsNamespacePrivateEndpointName_resource 'Microsoft.Network/privateEndpoints@2020-04-01' = {
  name: eventHubsNamespacePrivateEndpointName
  location: location
  properties: {
    privateLinkServiceConnections: [
      {
        name: eventHubsNamespacePrivateEndpointName
        properties: {
          privateLinkServiceId: eventHubsNamespaceId
          groupIds: [
            eventHubsNamespacePrivateEndpointGroupName
          ]
        }
      }
    ]
    ...
    customDnsConfigs: [
      {
        fqdn: concat(eventHubsNamespaceName, eventHubsPublicDNSZoneForwarder)
      }
    ]
  }
  dependsOn: [
...
resource eventHubsNamespacePrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2020-03-01' = {
  name: eventHubsNamespacePrivateDnsZoneGroup_var
  location: location
  properties: {
    privateDnsZoneConfigs: [
      {
        name: 'dnsConfig'
        properties: {
          privateDnsZoneId: eventHubsNamespacePrivateDnsZoneId
        }
      }
    ]
  }
...
output eventHubsNamespacePrivateEndpoint object = reference(eventHubsNamespacePrivateEndpointName_resource.id, '2020-04-01', 'Full')
...
output eventHubsNamespaceName object = reference(eventHubsNamespaceName_resource.id, '2018-01-01-preview', 'Full')
